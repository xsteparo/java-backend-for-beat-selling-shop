...
export const TrackRow: FC<TrackRowProps> = ({
                                                track, role, liked, onPlay, onBuy, onRemove, onToggleLike
                                            }) => (
    <div className="flex w-full items-center bg-gray-800 rounded-xl px-6 py-4 space-x-4">
        <button
            onClick={() => onPlay(String(track.id))}
        ...
        <div className="flex-grow min-w-0 max-w-[250px] flex flex-col">
      <span className="text-white font-semibold truncate">
        ...
        <div className="flex-none w-24 flex items-center justify-end space-x-3">
            <button onClick={() => onToggleLike(String(track.id))} className="p-1">
            ...
            {role === 'admin' ? (
                <>
                    ...
                    <button
                        onClick={() => onRemove(String(track.id))}
